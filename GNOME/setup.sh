...
dnf install -y python3-jedi clang clang-libs glide make qt5-qtquickcontrols qt5-qtquickcontrols2
dnf install -y dia meld sqlitebrowser gitg
dnf install -y gcc
dnf install -y gtk+-devel gtk3-devel libsoup-devel zlib.i686 ncurses-libs.i686 bzip2-libs.i686 python3-devel gtksourceview3-devel @development-libs qt5-devel qt5-qtquickcontrols2-devel
dnf install -y fedora-packager fedora-review @rpm-development-tools meson ninja-build
dnf install -y gtk3-devel-docs qt-doc qt5-qtquickcontrols2-doc
